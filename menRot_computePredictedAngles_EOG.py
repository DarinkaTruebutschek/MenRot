...
def computePredictedAngles_EOG(my_analysis, my_visibility, my_bins, my_split):
	...
	if ListAnalysis[0] is not 'InferResp_TrainAll_TestAll':
		...
		res_path = '/neurospin/meg/meg_tmp/MenRot_Truebutschek_2016/Decoding/newPipeline/Grouped/FiveFolds/IntermediateLocations/EOG/' + ListAnalysis[0] + '/GroupRes/Stats/'
	else:
