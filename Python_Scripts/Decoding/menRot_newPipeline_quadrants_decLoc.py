...
def menRot_newPipeline_quadrants_decLoc(wkdir, Condition, Subject, FileName, decCond):
	...
	from menRot_newPipeline_doRegression_final import menRot_newPipeline_doRegression_final
	from menRot_newPipeline_quadrants_loc_cfg import (result_path)
	from menRot_newPipeline_quadrants_loc_cfg import grouped, n_folds
	...
	def menRot_prepReg_loc(wkdir, Condition, Subject, FileName, decCond):
		...
		from menRot_newPipeline_loc_cfg import (data_path, baseline, baseline_loc, downsampling, trainTime, testTime, prediction_method, probabilities, scorer, featureSelection, loc, n_folds, baselineCorr)
		...
		if loc is 1:
			...
			if not grouped:
				...
				target_loc[target_loc == 3] = 1
				target_loc[target_loc == 4] = 1
				target_loc[target_loc == 5] = 1
				target_loc[target_loc == 6] = 1
				target_loc[target_loc == 7] = 2
				target_loc[target_loc == 8] = 2
				target_loc[target_loc == 9] = 2
				target_loc[target_loc == 10] = 2
				target_loc[target_loc == 11] = 2
				target_loc[target_loc == 12] = 2
				target_loc[target_loc == 13] = 3
				target_loc[target_loc == 14] = 3
				target_loc[target_loc == 15] = 3
				target_loc[target_loc == 16] = 3
				target_loc[target_loc == 17] = 3
				target_loc[target_loc == 18] = 3
				target_loc[target_loc == 19] = 4
				target_loc[target_loc == 20] = 4
				target_loc[target_loc == 21] = 4
				target_loc[target_loc == 22] = 4
				target_loc[target_loc == 23] = 4
				target_loc[target_loc == 24] = 4
		...
		if not grouped:
			...
			respnPos[respnPos == 3] = 1
			respnPos[respnPos == 4] = 1
			respnPos[respnPos == 5] = 1
			respnPos[respnPos == 6] = 1
			respnPos[respnPos == 7] = 2
			respnPos[respnPos == 8] = 2
			respnPos[respnPos == 9] = 2
			respnPos[respnPos == 10] = 2
			respnPos[respnPos == 11] = 2
			respnPos[respnPos == 12] = 2
			respnPos[respnPos == 13] = 3
			respnPos[respnPos == 14] = 3
			respnPos[respnPos == 15] = 3
			respnPos[respnPos == 16] = 3
			respnPos[respnPos == 17] = 3
			respnPos[respnPos == 18] = 3
			respnPos[respnPos == 19] = 4
			respnPos[respnPos == 20] = 4
			respnPos[respnPos == 21] = 4
			respnPos[respnPos == 22] = 4
			respnPos[respnPos == 23] = 4
			respnPos[respnPos == 24] = 4
			
			#Recode inferTar
			inferTar[inferTar == 2] = 1
			inferTar[inferTar == 3] = 1
			inferTar[inferTar == 4] = 1
			inferTar[inferTar == 5] = 1
			inferTar[inferTar == 6] = 1
			inferTar[inferTar == 7] = 2
			inferTar[inferTar == 8] = 2
			inferTar[inferTar == 9] = 2
			inferTar[inferTar == 10] = 2
			inferTar[inferTar == 11] = 2
			inferTar[inferTar == 12] = 2
			inferTar[inferTar == 13] = 3
			inferTar[inferTar == 14] = 3
			inferTar[inferTar == 15] = 3
			inferTar[inferTar == 16] = 3
			inferTar[inferTar == 17] = 3
			inferTar[inferTar == 18] = 3
			inferTar[inferTar == 19] = 4
			inferTar[inferTar == 20] = 4
			inferTar[inferTar == 21] = 4
			inferTar[inferTar == 22] = 4
			inferTar[inferTar == 23] = 4
			inferTar[inferTar == 24] = 4
		...
		####################################################################
		#Decoding
		gat, score, diagonal = menRot_newPipeline_doRegression_final(X_train, y_train, X_test, y_test, params)	
	...
	if (grouped and n_folds == 5):
		...
		myFolder = '/Quadrants/TwoFolds/'
	else:
		myFolder = '/'
	
	#Save data
	fname = result_path + '/newPipeline/' + myFolder + FileName + '/IndRes/' + Subject + '_' + Condition[0] + '_' + Condition[1] + '-params'
	np.save(fname, params)
	
	fname1 = result_path + '/newPipeline/' + myFolder + FileName + '/IndRes/' + Subject + '_' + Condition[0] + '_' + Condition[1] + '-time'
	np.save(fname1, time)
	
	fname2 = result_path + '/newPipeline/' + myFolder + FileName + '/IndRes/' + Subject + '_' + Condition[0] + '_' + Condition[1] + '-gat'
	np.save(fname2, gat)
	
	fname3 = result_path + '/newPipeline/' + myFolder + FileName + '/IndRes/' + Subject + '_' + Condition[0] + '_' + Condition[1] + '-score'
	np.save(fname3, score)
	
	fname4 = result_path + '/newPipeline/' + myFolder + FileName + '/IndRes/' + Subject + '_' + Condition[0] + '_' + Condition[1] + '-diagonal'
