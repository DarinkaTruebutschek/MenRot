...
result_path, FileName, Subject, Condition):
	...
	#Save gat as pickle
	fsave = result_path + '/newPipeline/Grouped/FiveFolds/Patterns/' + FileName + '/IndRes/' + Subject + '_' + Condition[0] + '_' + Condition[1] + params['freq'] + '-gatForWeights.p'
	...
	y_pred = gat.y_pred_
	fsave = result_path + '/newPipeline/Grouped/FiveFolds/Patterns/' + FileName + '/IndRes/' + Subject + '_' + Condition[0] + '_' + Condition[1] + params['freq'] + '-y_pred.p'
	pickle.dump(y_pred, open(fsave, "wb"))
	#scores = gat.score()
	
	#Save gat as pickle
	fsave = result_path + '/newPipeline/Grouped/FiveFolds/Patterns/' + FileName + '/IndRes/' + Subject + '_' + Condition[0] + '_' + Condition[1] + params['freq'] + '-gatForDis.p'
	pickle.dump(gat, open(fsave, "wb"))
