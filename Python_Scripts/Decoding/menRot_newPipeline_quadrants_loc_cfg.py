...
n_folds = 2 #normally, this will be a 5-fold cv scheme, but when only looking at certain subsets (e.g., Train_noRot_Test_noRot) it is 2 due to the lower number of trials)
baselineCorr = True
grouped = True
