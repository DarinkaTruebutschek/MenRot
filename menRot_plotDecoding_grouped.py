...
#Path
path = '/neurospin/meg/meg_tmp/MenRot_Truebutschek_2016/Decoding/Grouped/ThreeFolds'
...
for ii, (my_analysis, ax_diag) in enumerate(zip(ListAnalysis, axes_alldiag)):
	...
	if (my_analysis is 'Loc_TrainAll_TestAll') or (my_analysis is 'Loc_TrainRot_TestRot') or (my_analysis is 'Loc_TrainNoRot_TestNoRot'):
		...
		tupIndex = 0
	elif (my_analysis is 'Loc_TrainAllUnseen_TestAllUnseen') or (my_analysis is 'Resp_TrainAllUnseen_TestAllUnseen') or (my_analysis is 'Infer_TrainAllUnseen_TestAllUnseen') or (my_analysis is 'Loc_TrainAllSeen_TestAllUnseen'):
		tupIndex = 5
	...
	if (my_analysis is not 'Loc_Trainloc_TestAllSeen') and (my_analysis is not 'Resp_Trainloc_TestAllSeen') and (my_analysis is not 'Infer_Trainloc_TestAllSeen'):
		...
		elif (my_analysis is 'Loc_TrainAllSeen_TestAllSeen') or (my_analysis is 'Infer_TrainAllSeen_TestAllSeen')or (my_analysis is 'Loc_TrainAllUnseen_TestAllUnseen') or (my_analysis is 'Resp_TrainAllUnseen_TestAllUnseen') or (my_analysis is 'Loc_TrainAllSeen_TestAllUnseen'):
